...
export default function Filters({
  ...
  return (
    <div className="card p-6 space-y-6">
      <h3 className="text-xs uppercase tracking-[0.2em] text-ink/45 -mb-1">
        Filtrer
      </h3>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Fra"
            value={value.kmFrom}
            onChange={(e) => set("kmFrom", e.target.value)}
          />
          ...
          <input
            ...
            placeholder="Til"
            value={value.kmTo}
            onChange={(e) => set("kmTo", e.target.value)}
          />
        </div>
      </div>
        ...
        >
          ...
          {options?.transmissions.map((t) => (
            <option key={t.value} value={t.value}>
              {t.value === "MANUEL" ? "Manuel" : "Automatik"}
            </option>
          ))}
        </select>
      </div>
